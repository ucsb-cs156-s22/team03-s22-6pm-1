...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                HelpRequest helpRequest = HelpRequest.builder()
                                .requesterEmail("123@gamil.com")
                                .teamId("666")
                                .tableOrBreakoutRoom("table")
                                .explanation("Help with test case")
                                .solved(false)
                                .requestTime(ldt)
                                .build();
        ...
        public void logged_in_user_can_get_all_HelpRequests() throws Exception {
                ...
                LocalDateTime ldt2 = LocalDateTime.parse("2022-03-08T00:00:00");

                HelpRequest helpRequest2 = HelpRequest.builder()
                                .requesterEmail("ggg@gamil.com")
                                .teamId("999")
                                .tableOrBreakoutRoom("brakout room")
                                .explanation("just say hi")
                                .solved(true)
                                .requestTime(ldt2)
                                .build();
        ...
        public void an_admin_user_can_post_a_new_request() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/HelpRequest/post?requesterEmail=123@gamil.com&teamId=666&tableOrBreakoutRoom=table&explanation=Help with test case&solved=false&requestTime=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void an_admin_user_can_post_a_new_request_2() throws Exception {
                ...
                // act
                MvcResult response = mockMvc.perform(
                                post("/api/HelpRequest/post?requesterEmail=123@gamil.com&teamId=666&tableOrBreakoutRoom=table&explanation=Help with test case&solved=true&requestTime=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_HelpRequest() throws Exception {
                ...
                HelpRequest helpRequestEdited = HelpRequest.builder()
                                ...
                                .explanation("Help with calculus")
                                .solved(true)
                                .requestTime(ldt2)
                                .build();
