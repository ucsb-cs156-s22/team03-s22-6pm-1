...
describe("UCSBMenuItemsIndexPage tests", () => {
    ...
    test("test what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/UCSBDiningCommonsMenuItem/all").reply(200, menuItemsFixtures.threeMenuItems);
        axiosMock.onDelete("/api/UCSBDiningCommonsMenuItem", {params: {id: 0}}).reply(200, "MenuItem with id 0 was deleted");
       ...
       expect(getByTestId(`${testId}-cell-row-0-col-id`)).toHaveTextContent("0"); 
        ...
        await waitFor(() => { expect(mockToast).toBeCalledWith("MenuItem with id 0 was deleted") });
